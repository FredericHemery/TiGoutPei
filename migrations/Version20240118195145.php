 ...
 */
final class Version20240118195145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client DROP COLUMN IF EXISTS role');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client ADD role VARCHAR(10) NOT NULL');
